    ...
    return (
        <div className="mt-5 container-fluid p-0">
            <div className="form-control d-flex border-0">
                ...
                <button className="button--primary button--custom" type="submit" onClick={handleLogout}>
                    <svg className="arrow-left" width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
